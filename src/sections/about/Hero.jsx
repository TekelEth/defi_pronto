	...
	return (
		<div className='w-full flex-col flex md:flex-row items-center'>
			<div className='md:w-1/2 w-full flex flex-col col-span-2 justify-start py-8'>
				<h1 className='font-orbitron font-normal text-[31px] lg:text-5xl text-white leading-[37px] lg:leading-[73px]'>
					Decentralized tokens built on the <span className='text-theme-main'>cardano network</span>
				</h1>
			...
			<div className='md:w-[50%] w-full mt-2 md:mt-0 flex items-center justify-start'>
				{/* eslint-disable-next-line @next/next/no-img-element */}
				<img src='/assets/backgrounds/looper.svg' alt='about' className='w-full h-[500px] bg-cover bg-center' />
			</div>
		</div>
	);
}
