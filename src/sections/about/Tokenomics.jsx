...
const TokenDetails = ({ title, amount }) => (
	<div className='flex flex-col h-[160px] bg-[#241B23] border-[#E74141] border-2 py-4 items-center text-center justify-center rounded-[20px] hover:shadow-shadow-card'>
