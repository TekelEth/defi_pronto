...
const Timing = ({ days, hours, minutes, seconds }) => {
	return (
		<div className='flex mb-6 w-full items-center justify-between'>
			<span className='font-orbitron md:text-[31px]  text-[20px] md:leading-[37.5px]  leading-[24px] text-white font-[400]'>
				{days}
			</span>
			<span className='font-orbitron md:text-[31px]  text-[20px] md:leading-[37.5px]  leading-[24px] text-white font-[400]'>
				:
...
function Duration({ total_raised, allocated }) {
	...
	return (
		<div className='bg-transparent justify-center px-6 md:px-10 flex border-2 w-full h-[618px] border-[#E74141] bg-[#241B23] rounded-[10px]  flex-col items-center min-h-[618px] box-border'>
