	...
	return (
		...
		>
			<div className={`flex justify-between ${show && 'mt-8'} duration-300 items-center`}>
				<h1
					className={`font-[400] font-monument leading-[22px] text-[15.5px] md:text-[19.3px] ${
						show && 'mb-3'
					} capitalize ${'text-white'}`}
				>
					{question}
				</h1>
				<Icon Clicked={() => setShow(!show)} icon='ri-arrow-down-s-line' className='text-lg text-[#C9C9C9]' />
			</div>
