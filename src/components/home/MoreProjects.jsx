		...
		<section id='features'>
			...
			<div className='max-w-screen-sm sm:text-center sm:mx-auto'>
				<div className='w-full px-4'>
					<div className='flex flex-row items-center justify-center box-border py-[10px] px-[24px] w-full lg:w-[696px] h-[33px] lg:h-[51px] border-2 border-theme-main rounded-[5px]'>
						<h5 className='font-DmSans font-bold text-base leading-[21px] text-white'>More Projects</h5>
					</div>
				</div>
				...
				<div className='w-full lg:max-w-[630px] mx-auto my-20 text-center'>
					<h2 className='mb-6 font-monument text-[25px] lg:text-[48.83px] leading-[30px] lg:leading-[59px] tracking-wide text-center text-white'>
				...
				{/* <div className='w-full lg:w-[620px] mx-auto my-20'>
					<h2 className='mb-6 font-monument text-[25px] lg:text-[48.83px] leading-[30px] lg:leading-[59px] text-center text-white'>
						The Future of Cardano Projects
					</h2>
					<p className='text-base text-theme-100 w-full font-DMSans leading-[21px] tracking-wide text-center'>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Odio imperdiet nibh at et neque. Sed
			...
			<div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
				<div className='text-center'>
					...
					<div className='w-[278px] h-[88px] mx-auto'>
						<h6 className='mb-2 text-white text-[25px] font-monument leading-[30px] text-center'>
							Vetted Projects
						</h6>
