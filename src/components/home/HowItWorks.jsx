...
const Workings = () => (
  <div className="text-center relative mb-16 md:mb-0">
	 ...
	 <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full border-2 border-theme-main sm:w-20 sm:h-20">
        <span className="font-monument text-xl text-theme-main leading-[24px]">
          1
        </span>
      </div>

    <div className="mx-auto mt-4 md:mt-8">
      <h6 className="mb-2 text-white text-[17px] font-monument leading-[24px] text-center">
    ...
    <section id="howitworks" >
      <div className="max-w-xl md:mx-auto sm:text-center lg:max-w-2xl ">
        <div className="lg:w-[620px] mx-auto mt-20">
          <h2 className="mb-6 font-monument text-[25px] leading-[30px] md:text-[48.83px] md:leading-[59px] text-center text-white">
            How It Works
          </h2>
        </div>
      </div>
