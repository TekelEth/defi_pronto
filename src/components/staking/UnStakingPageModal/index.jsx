...
function EnterUnStakeAmount({ nextStep }) {
	...
	return (
		<div>
			<h5 className='font-monument text-[20px] leading-[30px] text-white'>Enter Unstake Amount</h5>
...
function ConfirmUnStakeAmount({ nextStep }) {
	...
	return (
		<div>
			<h5 className='font-monument text-[20px] leading-[30px] text-white'>Confirm Unstake Amount</h5>
			<p className='font-DmSams text-[12px] leading-[17px] text-theme-100 mt-1'>
...
function UnStakeCompletedd() {
	return (
		<div>
			<h5 className='font-monument text-[20px] leading-[30px] text-white'>Unstake Completed</h5>
