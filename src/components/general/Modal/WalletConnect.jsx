...
const Wallet = ({ img, name, close }) => {
	return (
		<div className='py-6 mb-4  px-6 md:px-8 hover:shadow-none cursor-pointer transition-all ease-in-out shadow-lg w-full flex bg-[#2F282E] rounded-[10px] justify-between items-center'>
			...
			<input type='checkbox' className='accent-[#E74141] cursor-pointer' onClick={close} />
		</div>
	);
};
			...
			>
				...
				>
					<div className='flex items-center w-full justify-between'>
						<h1 className='font-orbitron font-[400] text-[20px] md:text-[29.25px] leading-[37.5px] text-white'>
							Connect Wallet
						</h1>
						<i
							className='ri-close-line text-3xl hover:bg-[#E74141]  p-1  cursor-pointer text-white rounded-[10px] hover:rounded-full hover:duration-500 transition-all ease-in-out  '
							onClick={() => close()}
						></i>
					</div>
					<div className='my-6 flex items-center'>
						<input type='checkbox' className='mr-3 accent-[#E74141]' />
						<span className='font-DMSans text-white text-[16px]  leading-[21px]'>
							{' '}
							I have read and accepted the <a className='text-[#E74141]'>Terms and Conditions</a>
						</span>
					</div>
