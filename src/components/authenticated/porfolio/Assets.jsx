...
export const AssetDetails = ({ name, amount, shift, symbol, first }) => (
  <div className={`flex flex-col ${shift && "mr-[8%]"}  items-start`}>
    <span className="text-[#E74141] capitalize font-monument mb-2 md:mb-1 text-[10px] md:text-[12px] leading-[12px] md:leading-[14.4px]">
      {name}
    </span>
    {first ? (
...
const MobileAsset = ({
  ...
  <div className="flex md:hidden mb-4 w-[90%] px-6 mx-auto flex-col items-center rounded-[20px] bg-[#2F282E] py-12 hover:shadow-shadow-card">
    ...
    <span className="font-monument   text-white text-center my-6 w-[179px] text-left  font-[400] leading-[24px]  text-[20px]">
      {asset_name}{" "}
    </span>
