...
export default function Nav() {
  ...
  const position = router.pathname === "/" ? "absolute" : "sticky";
  return (
    <div
      className={` ${position} inset-x-0 z-30 top-0 px-4 py-6 w-full max-w-full bg-transparent md:px-5 lg:px-5 mx-auto`}
    >
      <div className="flex items-center max-w-[90%] mx-auto justify-between">
        <CustomLink href={"/"} className="flex items-center">
          <img
            src="/assets/logo.svg"
            alt="Defi Pronto Logo"
            className=" w-14"
          />
        </CustomLink>
        <div className="hidden md:flex lg:flex items-center gap-7">
          ...
          <button className="flex flex-row justify-center items-center py-[15px] px-[32px] gap-2 text-white bg-theme-main rounded-[5px]">
            <span className="text-base font-DMSans font-bold leading-[21px]">
              Connect Wallet
            </span>
